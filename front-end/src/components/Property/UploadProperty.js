...
const UploadProperty = (props) => {
    let formSubmitHandler = async (e) => {
        ...
        try{
            ...
            const nightlyFee = document.getElementById("inputNightlyFee").value;
            const cleaningFee = document.getElementById("inputCleaningFee").value;
            const tax = document.getElementById("inputTax").value;
            ...
            let response = await fetch("http://localhost:3000/api/properties", {
                ...
                body: JSON.stringify({
                    title: title,
                    house_type: radio_house_type,
                    prop_type:radio_prop_type,
                    max_guests: 4,
                    bedrooms: 2,
                    address: {
                        street: address1,
        ...
        <>
            <form class="row g-3 m-4" onSubmit={formSubmitHandler}>
                <div class="prop_upload_topmenu">
                    ...
                    <input type="text" class="form-control" id="inputTitle"         placeholder="Tiffany's haven"/>
                    </div>
                ...
                <div class="col-12">
                    <label for="inputAddress2" class="form-label">House number</label>
                ...
                <div class="amenities">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="hairdryer" />
                        <label class="form-check-label" for="flexCheckChecked">
                            Hair Dryer
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="pet_friendly" />
                        <label class="form-check-label" for="flexCheckChecked">
                            Pet Friendly
                        </label>
                    </div>
                ...
                <div class="fee-block">
                    <div class="col-md-2">
                        <label for="inputNightlyFee" class="form-label">Price per night</label>
                        <input type="number" class="form-control" id="inputNightlyFee" />
                    </div>
                    <div class="col-md-2">
                        <label for="inputCleaningFee" class="form-label">Cleaning fee</label>
